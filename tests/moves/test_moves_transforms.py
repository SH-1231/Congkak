...
def test_move_normal(
    ...
    print(new_board_state.player_one.side, expected_board_state.player_one.side)
    assert np.all(new_board_state.player_one.side == expected_board_state.player_one.side)
    assert np.all(new_board_state.player_two.side == expected_board_state.player_two.side)
